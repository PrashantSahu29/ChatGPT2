      ...
      <div>
        <form onSubmit={handleSubmit} className="expense-claim-form">
          ...
          <div className="form-row">
            ...
            <textarea id="description" value={description} onChange={handleDescriptionChange} maxLength={200} placeholder="" />
          </div>
          ...
          <div className="form-row">
            ...
            <input
              placeholder={`Upto 2 decimals, max: ${category && categories.find((item) => item.name === category).maxAmount}`}
              type="number"
              step="0.01"
              id="claim-amount"
              value={claimAmount}
          ...
          <ToastContainer position="top-right" autoClose={3000} closeOnClick rtl={false} pauseOnFocusLoss pauseOnHover draggable theme="colored" />
        </form>
      </div>
    </div>
  );
